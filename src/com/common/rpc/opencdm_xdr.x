...
program OPEN_CDM {
    ...
    rpc_response_generic RPC_OPEN_CDM_MEDIAKEYSESSION_RELEASE(rpc_request_session_release) = 7;
    rpc_response_generic RPC_OPEN_CDM_MEDIAENGINE(rpc_request_mediaengine_data) = 8;
    } = 1;
} = 0x61135687; /* FAMEFHG */
